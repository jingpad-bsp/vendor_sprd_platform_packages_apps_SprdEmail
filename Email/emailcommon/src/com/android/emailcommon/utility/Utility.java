...
public class Utility {
     ...
     */
    /**
     * add for checking file with this URI exists.
     * @param context
     * @param fileUri
     * @return
     */
    public static boolean fileExists(Context context, Uri fileUri) {
        if (fileUri == null) {
            ...
            /* SPRD: Modify for bug565007 {@ */
                ...
                LogUtils.e(LogUtils.TAG, "SecurityException when file not exist.", e);
                return false;
            /* @} */
            } finally {
                try {
                    ...
                    LogUtils.w(LogUtils.TAG, " IO exception when file exist.");
                }
            }
        }
    }
    public static boolean fileIsExistInDownload(String fileName){
    ...
    public static boolean isInternalStorageMounted() {
        return EnvironmentEx.getInternalStoragePathState().equals(Environment.MEDIA_MOUNTED);
    }
