...
import com.android.emailcommon.utility.HanziToPinyin;
import com.android.emailcommon.utility.HanziToPinyin.Token;
...
public abstract class EmailContent {
    ...
    public interface MessageColumns extends BaseColumns, SyncColumns {
        ...
        public static final String SUBJECT_SORT_KEY = "subject_sort_key";

        public static final String DISPLAY_NAME_SORT_KEY = "display_name_sort_key";
    }
    ...
    public static final class Message extends EmailContent {
        ...
        private static final int SORT_KEY_MAX_LEN = 50;
         ...
         *@{
         */
        public static final int FLAG_TYPE_PRIORITY_HIGH = 1 << 22;
        public static final int FLAG_TYPE_PRIORITY_LOW = 1 << 23;
        /*@}*/
        ...
        public static final int FLAG_LOCALLY_REMOVED = 1 << 25;
        /* @} */
        /* SPRD modify for bug681671{@ */
        public static final int FLAG_MEETTING_RESPONSED = 1 << 26;
        /* @} */
        ...
        public static String buildLocalSearchSelection(String filter, String searchField) {
            StringBuilder sb = new StringBuilder();
            return sb.append("LOWER(").append(searchField).append(")").append(" LIKE '%")
                    .append(filter.toLowerCase()).append("%'").append(" ESCAPE \'\\'")
                    .append(" OR ").toString();
        }

        public static String buildLocalSearchBodySelection(String filter) {
            StringBuilder sb = new StringBuilder();
            return sb.append(BaseColumns._ID).append(" IN (SELECT ")
                    .append(BodyColumns.MESSAGE_KEY).append(" FROM ").append(Body.TABLE_NAME)
                    .append(" WHERE ").append("LOWER(").append(BodyColumns.TEXT_CONTENT)
                    .append(")").append(" LIKE '%").append(filter.toLowerCase()).append("%'")
                    .append(" ESCAPE \'\\'").append(")").append(" OR ").toString();
        }
        /* @} */

        public static String getPinYinSortKey(String source) {
            ArrayList<Token> tokens = HanziToPinyin
                    .getInstance().getTokens(source);
            StringBuilder sb = new StringBuilder();
    ...
    public static final class Attachment extends EmailContent implements Parcelable {
        ...
        public static final int FLAG_RENAMED_TO_LEGAE = 1 << 11;
        /* @} */

        /* SPRD modify for bug652656 {@ */
        public static final int FLAG_INVALID_TO_DOWNLOAD = 1 << 12;
        /* @} */

        /* UNISOC: Modify for bug1047400 {@ */
        public static final int FLAG_DOWNLOAD_CANCELLED = 1 << 13;
        /* @} */
        /**
         * no public constructor since this is a utility class
         */
        ...
        public String toString() {
            /* UNISOC: Modify for bug 1208399 {@ */
            return "[" + mFileName + ", " + mMimeType + ", " + mSize + ", " + mContentId + ", "
                    + mContentUri + ", " + mCachedFileUri + ", " + mMessageKey + ", "
                    + mLocation + ", " + mEncoding  + ", " + mFlags + ", " + mAccountKey +  ","
                    + mUiState + "," + mUiDestination + "," + mUiDownloadedSize + "]";
            /* @}  */
        }
    }
