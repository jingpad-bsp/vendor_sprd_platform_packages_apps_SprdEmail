...
public final class Account extends EmailContent implements Parcelable {
    ...
    public Uri save(Context context) {
        ...
        if (mHostAuthSend != null) {
            if (mHostAuthSend.mCredential != null && mHostAuthRecv != null) { //UNISOC: Modify for bug1208394
                if (mHostAuthRecv.mCredential != null &&
        ...
        try {
            ...
            if (recvIndex >= 0 && mHostAuthRecv != null) {  //UNISOC: Modify for bug1208394
                long newId = getId(results[recvIndex].uri);
                mHostAuthKeyRecv = newId;
                mHostAuthRecv.mId = newId;
            }
            if (sendIndex >= 0 && mHostAuthSend != null) {  //UNISOC: Modify for bug1208394
