...
public class Mailbox extends EmailContent implements EmailContent.MailboxColumns, Parcelable {
    ...
    public static String getSystemMailboxName(Context context, int mailboxType) {
        ...
        switch (mailboxType) {
            ...
            case Mailbox.TYPE_VIP:
                resId = R.string.mailbox_name_server_vip;
                break;  //UNISOC: Modify for bug1208409
            default:
    ...
    public static List<Mailbox> getMailboxesByAccountId(Context context, long accountId) {
        ...
        try {
            ...
            LogUtils.w(Logging.LOG_TAG, e, "Failed to get mailboxs by accountId %d", accountId);
        } finally {
            if (cursor != null) {
                cursor.close();
            }
    ...
    public static void resyncMailbox(final ContentResolver cr,
        ...
        try {
            ...
            LogUtils.d(Logging.LOG_TAG, "requestSync resyncMailbox %s, %s",
