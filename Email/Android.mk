...
# Sprd Modify for bug691857 {@
res_dir := res
outside_res_dir:= $(emailcommon_dir)/res
# @}
...
LOCAL_SRC_FILES += $(call all-java-files-under, src/com/sprd)

# Sprd Modify for bug691857 {@
LOCAL_RESOURCE_DIR := $(addprefix $(LOCAL_PATH)/, $(res_dir))
LOCAL_RESOURCE_DIR += vendor/sprd/platform/packages/apps/SprdEmail/UnifiedEmail/res
LOCAL_RESOURCE_DIR += $(addprefix $(LOCAL_PATH)/, $(outside_res_dir))
# @}
