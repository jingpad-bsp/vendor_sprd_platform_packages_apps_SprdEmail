...
public class AccountCheckSettingsFragment extends Fragment {
    ...
    public interface Callback {
        ...
        void onCheckSettingsError(int reason, ErrorMessage message);
        /* @} */
        /**
        ...
        void onCheckSettingsAutoDiscoverComplete(HostAuth autoDiscoverResult);
        /*@}*/
    }
        ...
        if (mAttached && !mPaused) {
            ...
            switch (newState) {
                ...
                case STATE_AUTODISCOVER_RESULT:
                    ...
                    /* SPRD:bug520850 add autodiscovery function {@ */
                    getCallbackTarget().onCheckSettingsAutoDiscoverComplete(autoDiscoverResult);
                    /*@}*/
                    break;
                default:
    ...
    private static class AccountCheckTask extends AsyncTask<Void, Integer, MessagingException> {
        ...
        private static final int RESULT_OTHER_FAILURE = -99;
        /*@}*/
        ...
        protected MessagingException doInBackground(Void... params) {
            try {
                if ((mMode & SetupDataFragment.CHECK_AUTODISCOVER) != 0) {
                    ...
                    /* SPRD:bug520850 add autodiscovery function {@ */
                    if (errorCode == RESULT_OTHER_FAILURE) {
                        return new AutoDiscoverResults(true, null);
                    } else if (errorCode != RESULT_OK) {
                        return new AutoDiscoverResults(false, null);
                    } else {
