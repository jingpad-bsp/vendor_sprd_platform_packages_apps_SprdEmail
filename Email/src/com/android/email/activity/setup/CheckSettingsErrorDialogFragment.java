...
public class CheckSettingsErrorDialogFragment extends DialogFragment{
    ...
    private final static String ARGS_RESID = "CheckSettingsErrorDialog.ResId";
    /* @} */
     ...
     */
    /* SPRD modify for bug694376 {@ */
    public static CheckSettingsErrorDialogFragment newInstance(int reason, ErrorMessage errorMessage) {
        final CheckSettingsErrorDialogFragment fragment = new CheckSettingsErrorDialogFragment();
        final Bundle arguments = new Bundle(2);
        arguments.putString(ARGS_MESSAGE, errorMessage.message);
        arguments.putInt(ARGS_RESID, errorMessage.resId);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        /* SPRD modify for bug694376 {@ */
        final String errorMessage = arguments.getString(ARGS_MESSAGE);
        final int resId = arguments.getInt(ARGS_RESID);
        ...
        if (reason == REASON_AUTHENTICATION_FAILED) {
            ...
            builder.setTitle(context.getString(R.string.account_setup_failed_dlg_title));
        }
    ...
    public static ErrorMessage getErrorString(Context context, MessagingException ex) {
        final int id;
        ...
        if (message != null) {
            ...
            if (language.endsWith("zh") || language.endsWith("en")) {
                try {
                    ...
                    LogUtils.w(LogUtils.TAG, "message coding errors: " + e.toString());
                }
            }
            /* @} */
        }
