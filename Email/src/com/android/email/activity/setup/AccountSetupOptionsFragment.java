...
public class AccountSetupOptionsFragment extends AccountSetupFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBackgroundAttachmentsView.setChecked(false); //UNISOC: Modify for bug 1255449
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        final CharSequence[] frequencyValues = Utils.getArrayResourceIdByFilter(context, serviceInfo.syncIntervals);
        final CharSequence[] frequencyEntries = Utils.getArrayResourceIdByFilter(context, serviceInfo.syncIntervalStrings);
        /* @} */
        ...
        /* SPRD: Modify for bug745562 @{ */
        if (!serviceInfo.syncContacts) {
            mSyncContactsView.setVisibility(View.GONE);
            UiUtilities.setVisibilitySafe(view, R.id.account_sync_contacts_divider, View.GONE);
        }
        if (!serviceInfo.syncCalendar) {
            mSyncCalendarView.setVisibility(View.GONE);
            UiUtilities.setVisibilitySafe(view, R.id.account_sync_calendar_divider, View.GONE);
        }
        /* @} */
