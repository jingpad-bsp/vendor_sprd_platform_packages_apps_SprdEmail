...
public class QuickResponsesCursorAdapter extends SimpleCursorAdapter{
    ...
    public static final String QUICK_RESPONSE_PREF_STATE = "respond_via_email_prefs_state_";

    public QuickResponsesCursorAdapter(Context context, int layout, Cursor c, String[] from,
                                       int[] to, int flags, String emailAddress) {
        ...
        statePrefs = context.getSharedPreferences(QUICK_RESPONSE_PREF_STATE + emailAddress,
