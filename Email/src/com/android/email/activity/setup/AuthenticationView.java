...
public class AuthenticationView extends LinearLayout implements OnClickListener {
    ...
    public void onFinishInflate() {
        ...
        /* SPRD modify for show password feature, modify for bug709217 {@ */
        mShowPasswordCheckbox = (CheckBox) UiUtilities.getView(this, R.id.show_password_checkbox);
        UiUtilities.setShowPasswordCheckbox(mShowPasswordCheckbox, mPasswordEdit);
        /* @} */
    ...
    public void setAuthInfo(final boolean offerOAuth, final HostAuth hostAuth) {
        ...
        if (mOfferOAuth && mUseOAuth) {
            ...
            /* SPRD: Modify for bug 750992 @{ */
            if (provider != null) {
                mOAuthLabel.setText(getContext().getString(
                        R.string.signed_in_with_service_label, provider.label));
            }
            /* @} */
        }
    ...
    public void setSettingMode(boolean isSettingMode) {
        ...
        mShowPasswordCheckbox.setVisibility(isSettingMode ? View.GONE : View.VISIBLE);
    }
    /* @} */
}
