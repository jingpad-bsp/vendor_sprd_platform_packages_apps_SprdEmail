...
public class AccountServerSettingsActivity extends AccountSetupActivity implements
    ...
    public void onBackPressed() {
        ...
        if (accountServerFragment != null) {
            if (accountServerFragment.haveSettingsChanged()) {
                ...
                /* SPRD: Modify for 700475 {@ */
                if(dialogFragment != null && isResumed()){
                    dialogFragment.showAllowingStateLoss(getFragmentManager(), UnsavedChangesDialogFragment.TAG);
                }
                /* @} */
    ...
    /* SPRD modify for bug694376, 720620 {@ */
    @Override
    public void onCheckSettingsError(int reason, ErrorMessage message) {
        ...
        CheckSettingsErrorDialogFragment.newInstance(reason, message)
                .showAllowingStateLoss(getFragmentManager(), CheckSettingsErrorDialogFragment.TAG);
    }
    /* @} */
    ...
    public static class UnsavedChangesDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(activity)
                    .setTitle(R.string.discard_changes)//SPRD: Modify for bug803725
                    ...
                    .setPositiveButton(
                            ...
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    /* SPRD: Modify for bug699929, 730453 @{ */
