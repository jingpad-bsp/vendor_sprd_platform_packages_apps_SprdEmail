    ...
    public static class MailboxSettingsFragment extends PreferenceFragment {
        ...
        public void onDestroy() {
            ...
            if (activity != null) {
                ...
                final String tittleName = getString(R.string.mailbox_settings_activity_title);
                if (actionBar != null) {
                    actionBar.setTitle(tittleName);
                    actionBar.setSubtitle("");
                } else {
                    activity.setTitle(tittleName);
                }
            }
            /* @} */
        }
