...
import com.android.email.activity.setup.QuickResponsesCursorAdapter;
...
public class InsertQuickResponseDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final SimpleCursorAdapter adapter = new QuickResponsesCursorAdapter(context,
