...
public class AccountSettingsOutOfOfficeFragment extends Fragment {
    ...
    public String onStarted() {
        /* SPRD: Modify for 704177 {@ */
        return (mReplySumm.getText()).toString().trim();
        /* @} */
    }

    /* SPRD modify for bug687291{@ */
    public static AccountSettingsOutOfOfficeFragment newInstance(Parcelable oofParams) {
    ...
    class AccountObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            /* SPRD: modify for bug700334, bug687291 @{ */
    ...
    private void checkAccountValidity() {
        ...
        android.util.Log.e("EmailOOF", "checkAccountValidity mAccount:" + mAccount);
        if (mAccount == null) {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        /* SPRD: modify for bug 611455, 687291 @{ */
    ...
    public void loadSettings(View view, Bundle bundle) {
        ...
        /* SPRD: Modify for 691347 {@ */
        mFromDateButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentManager fm = getFragmentManager();
                DateTimePickerDialogFragment fragment = (DateTimePickerDialogFragment) fm
                        .findFragmentByTag(DateTimePickerDialogFragment.TAG + PICK_FROM_DATE);
                if (fragment == null) {
                    DateTimePickerDialogFragment  newFragment = DateTimePickerDialogFragment
                    .newInstance(AccountSettingsOutOfOfficeFragment.this, PICK_FROM_DATE);
                    newFragment.show(getFragmentManager(), DateTimePickerDialogFragment.TAG + PICK_FROM_DATE);
                }
             }
        });
        ...
        mToDateButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager fm = getFragmentManager();
                DateTimePickerDialogFragment fragment = (DateTimePickerDialogFragment) fm
                        .findFragmentByTag(DateTimePickerDialogFragment.TAG + PICK_TO_DATE);
                if (fragment == null) {
                    DateTimePickerDialogFragment  newFragment = DateTimePickerDialogFragment
                    .newInstance(AccountSettingsOutOfOfficeFragment.this, PICK_TO_DATE);
                    newFragment.show(getFragmentManager(), DateTimePickerDialogFragment.TAG + PICK_TO_DATE);
                }
            }
        });
        ...
        mFromTimeButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager fm = getFragmentManager();
                DateTimePickerDialogFragment fragment = (DateTimePickerDialogFragment) fm
                        .findFragmentByTag(DateTimePickerDialogFragment.TAG + PICK_FROM_TIME);
                if (fragment == null) {
                    DateTimePickerDialogFragment  newFragment = DateTimePickerDialogFragment
                    .newInstance(AccountSettingsOutOfOfficeFragment.this, PICK_FROM_TIME);
                    newFragment.show(getFragmentManager(), DateTimePickerDialogFragment.TAG + PICK_FROM_TIME);
                }
        ...
        mToTimeButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentManager fm = getFragmentManager();
                DateTimePickerDialogFragment fragment = (DateTimePickerDialogFragment) fm
                        .findFragmentByTag(DateTimePickerDialogFragment.TAG + PICK_TO_TIME);
                if (fragment == null) {
                    DateTimePickerDialogFragment  newFragment = DateTimePickerDialogFragment
                    .newInstance(AccountSettingsOutOfOfficeFragment.this, PICK_TO_TIME);
                    newFragment.show(getFragmentManager(), DateTimePickerDialogFragment.TAG + PICK_TO_TIME);
                }
            }
        });
        /* @} */
        mReplyView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fragment == null) {
                    ...
                    CharSequence text = mReplySumm.getText();
        ...
        mSaveButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /* SPRD modify for bug693993{@ */
                CharSequence text = mReplySumm.getText();
                editor.putString(OOF_REPLY + mAccount.mId,
                        TextUtils.isEmpty(text) ? "" : text.toString().trim());
                /* @} */
                editor.putString(OOF_REPLY + mAccount.mId,
                        TextUtils.isEmpty(text) ? "" : text.toString().trim());
                editor.commit();
            ...
            if (mIsSaveAlert) {
                ...
                .setPositiveButton(R.string.okay_action,
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        /* SPRD: Modify for bug 740070  @{ */
                        FragmentManager fm = getFragmentManager();
                        if (fm != null) {
                            AccountSettingsOutOfOfficeFragment fragment = (AccountSettingsOutOfOfficeFragment)
                                fm.findFragmentByTag(AccountSettingsOutOfOfficeFragment.TAG);
                ...
                dialogBuilder.setTitle(mTitleId).setMessage(mMessageId)
                        .setPositiveButton(R.string.okay_action,
                                new DialogInterface.OnClickListener() {
                            @Override
    ...
    public void setDisplay(Bundle bundle) {
        ...
        /* SPRD: Modify for bug 733122  @{ */
        if (null != s && TextUtils.isEmpty(mReplySumm.getText())) {
    ...
    public void enableOutOfficeOption() {
        ...
        /* SPRD: Modify for 697474 {@ */
        mReplySumm.setHintTextColor(getResources().getColor(R.color.text_hint_color));
        /* @} */
    ...
    public void disableOutOfficeOption() {
        ...
        /* SPRD: Modify for 697474 {@ */
        mReplySumm.setHintTextColor(getResources().getColor(R.color.editor_disabled_text_color));
        /* @} */
    ...
    public static class DateTimePickerDialogFragment extends DialogFragment {
        ...
        public static DateTimePickerDialogFragment newInstance(
                AccountSettingsOutOfOfficeFragment fragment,int dialogId) {
            final DateTimePickerDialogFragment dialog = new DateTimePickerDialogFragment();
            dialog.setTargetFragment(fragment, dialogId);
            return dialog;
        }
        /* @} */
        @Override
