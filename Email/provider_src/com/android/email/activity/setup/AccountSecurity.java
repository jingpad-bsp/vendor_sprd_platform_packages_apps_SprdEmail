...
public class AccountSecurity extends Activity {
    ...
    private static final int REQUEST_EXCHANGE_PERMISSION = 4; //UNISOC: Modify for bug 1147225
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (extras == null) {
            ...
            if (!TextUtils.isEmpty(value)) {
                showDialog = Boolean.valueOf(value);//UNISOC:Modify for bug1208496
            }
    ...
    protected void completeCreate(final Account account, final boolean showDialog,
        ...
        mAccount = account;
        startRequestPermission(); //UNISOC: Modify for bug 1147225
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_EXCHANGE_PERMISSION) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                LogUtils.e(LogUtils.TAG, "Unknown result from exchange permission request %d",resultCode);
                Toast.makeText(this, R.string.missing_required_permission, Toast.LENGTH_SHORT).show();
                repostNotification(mAccount, SecurityPolicy.getInstance(this));
                finish();
            }
        }
        /* @} */
