...
public class FolderPickerActivity extends Activity implements FolderPickerCallback {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (uri != null) {
            ...
            if (uiAccount == null || uiAccount.uri == null) {
                LogUtils.i(LogUtils.TAG, "uiAccount or its uri is null!");
                finish();
                return;
            }
            /* @} */
    ...
    private class AccountObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            /* UNISOC: Modify for bug 1220151 {@ */
            if (account != null && (account.mFlags & Account.FLAGS_INITIAL_FOLDER_LIST_LOADED) != 0 &&
                    (mAccountObserver != null)) {
