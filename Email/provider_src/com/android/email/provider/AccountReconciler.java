...
import com.sprd.email.omacp.OmacpSyncUtils;
...
public class AccountReconciler {
    ...
    public static synchronized void reconcileAccounts(final Context context) {
        ...
        LogUtils.i(Logging.LOG_TAG, "Begin reconcileAccounts");
    ...
    private static boolean reconcileAccountsInternal(
        ...
        for (final Account providerAccount : emailProviderAccounts) {
            ...
            if (Account.isSecurityHold(context, providerAccount.mId)) {
                LogUtils.d(Logging.LOG_TAG, "Account %d is on security hold", providerAccount.mId);
                final NotificationController nc =
                        NotificationControllerCreatorHolder.getInstance(context);
                nc.showSecurityNeededNotification(providerAccount);
            }
            /* @} */
            ...
            if (infoForAccount == null || !hasAmAccount(
                ...
                if (performReconciliation) {
                    ...
                    LogUtils.i(Logging.LOG_TAG, "reconcileAccountsInternal id:"
                            + providerAccount.mId);
        ...
        /*SPRD: Delete 20151027 of Bug488277, enabled the compose activity. @{
        ...
        /*
         * reconcile the accounts cache in MailAppProvider with which in
         * AccountMannager.
         */
        MailAppProvider.reconcileAccountsCache(context);
        ...
        if (accountsDeleted > 0) {
            ...
            //System.exit(-1);  //SPRD:Delete account function from AccountSettings.
        }
