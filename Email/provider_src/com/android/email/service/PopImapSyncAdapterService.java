...
public class PopImapSyncAdapterService extends Service {
    ...
    private static class SyncAdapterImpl extends AbstractThreadedSyncAdapter {
        public SyncAdapterImpl(Context context) {
            /* SPRD: modify for bug510788, allow syncs for different accounts to run at the same time @{ */
            super(context, true /* autoInitialize */,true);
            /* @} */
        }
    ...
    private static void sync(final Context context, final long mailboxId,
        ...
        if ((mailbox.mType != Mailbox.TYPE_OUTBOX) &&
            ...
            EmailServiceStatus.syncMailboxStatus(resolver, extras, mailboxId,
                    EmailServiceStatus.IN_PROGRESS, 0, EmailContent.LAST_SYNC_RESULT_SUCCESS);
            ...
            EmailServiceStatus.syncMailboxStatus(resolver, extras, mailboxId,
                    EmailServiceStatus.SUCCESS, 0, EmailContent.LAST_SYNC_RESULT_SUCCESS);
            /* @} */
            return;
        }
        ...
        try {
            ...
            try {
                ...
                LogUtils.e(TAG, "Sync exception!!! Type:" + type);
    ...
    private static void performSync(Context context, android.accounts.Account account,
        ...
        Cursor c = null;
        try {
            c = provider.query(Account.CONTENT_URI,
        ...
        } catch (RemoteException e) {  //UNISOC: Modify for bug1234478
            e.printStackTrace();
        } finally {
            if (c != null) {
                c.close();
