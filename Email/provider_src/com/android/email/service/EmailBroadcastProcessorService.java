...
public class EmailBroadcastProcessorService extends IntentService {
    ...
    public static String NOTIFICATION_CHANNEL = "EMAIL_BROADCAST_NOTIFICATION_CHANNEL";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        /* SPRD modify for bug809670 {@ */
        if (intent == null) {
            // Log stack trace in case there are any produceable test cases
            LogUtils.i(Logging.LOG_TAG, new Throwable(),
                    "EmailBroadcastProcessorService onHandleIntent intent is null.");
            return;
        }
        /* @} */
