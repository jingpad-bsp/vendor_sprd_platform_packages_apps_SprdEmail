...
//        public boolean usesAutodiscover;//UNISOC: Modify for bug1221828
        ...
        public String syncIntervalStrings;
        public String syncIntervals;
        /* @} */
    ...
    /* SPRD: Modify for bug601453{@ */
    /**
     * Determine if the locale changes
     */
    public static boolean isLocaleChanges(final Context context) {
        /* UNISOC: Modify for bug1221828 @{ */
        synchronized (sServiceMapLock) {
            ...
            final int delta =
                    sOldConfiguration.diff(context.getResources().getConfiguration());
                ...
                while ((xmlEventType = xml.next()) != XmlResourceParser.END_DOCUMENT) {
                    if (xmlEventType == XmlResourceParser.START_TAG &&
                        ...
                        info.syncIntervalStrings =
                            ta.getString(R.styleable.EmailServiceInfo_syncIntervalStrings);
                        info.syncIntervals =
                            ta.getString(R.styleable.EmailServiceInfo_syncIntervals);
                        /* @} */
                        ...
                        ta.recycle();//UNISOC: Modify for bug 1179198
                    }
                }
    ...
    class NullService implements IEmailService {
        ...
        @Override
        public OofParams syncOof(long accountId, OofParams oofParams, boolean isGet) throws RemoteException {
            return null;
        }

        @Override
        public void stopOof(long accountId) throws RemoteException {
        }
        /* @} */
    }
