...
public abstract class AbstractConversationViewFragment extends Fragment implements
    ...
    public FolderController getFolderController() {
        final ControllableActivity activity = (ControllableActivity) getActivity();
        return activity != null ? activity.getFolderController() : null;
    }
    /* @} */
    ...
    public ContactLoaderCallbacks getContactInfoSource() {
        /* SPRD: Modify for bug712843 @{ */
        if (mContactLoaderCallbacks == null && mActivity != null) {
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        final MenuItem readMenuItem = menu.findItem(R.id.inside_conversation_unread);
        if (readMenuItem != null) {
            if (mConversation.isInDraft()) {
