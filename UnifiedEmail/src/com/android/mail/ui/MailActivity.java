...
public class MailActivity extends AbstractMailActivity implements ControllableActivity {
    ...
    /* SPRD: Modify for bug733064 @{ */
    private long lastSelecteTime = 0;
    /* @} */
    ...
    public void onCreate(Bundle savedState) {
        ...
        com.sprd.email.AsynPreloader.preload(this);
    ...
    /* SPRD modify for bug738293 bug760321 {@ */
    @Override
    public boolean dispatchKeyEvent(KeyEvent event) {
        final int keyCode = event.getKeyCode();
        if (ViewMode.isListMode(mViewMode.getMode()) && keyCode == KeyEvent.KEYCODE_MENU
                && event.getAction() == KeyEvent.ACTION_UP && mController.showActionModeMenu()) {
            return true;
        }
    ...
    /* SPRD: Modify for bug733064 @{ */
    private boolean isClickGapsShort() {
        long curTime = System.currentTimeMillis();
        long gaps = curTime - lastSelecteTime;

        lastSelecteTime = curTime;
    ...
    public void onResume() {
        ...
        /* SPRD: Modify for bug738666, 740821 @{ */
        if (!OsUtils.hasPermissions(this.getActivityContext(), OsUtils.REQUIRED_PERMISSIONS)) {
            System.exit(-1);
            return;
        }
        /* @} */
    ...
    public void showOrDismissTopButton(int mode, GoToTopCallback callback) {
        mController.showOrDismissTopButton(mode, callback);
    }
    ...
    public void onFooterViewRemoteSearchClick() {
        mController.onFooterViewRemoteSearchClick();
    }
    /* @} */
