...
import com.android.mail.preferences.MailPrefs.SnippetShowLinesValue;
...
public class GeneralPrefsFragment extends MailPreferenceFragment
    ...
    private ListPreference mSnippetShowLines;
    private static final int[] SNIPPET_SHOW_LINES_VALUES = {
            SnippetShowLinesValue.NONE, // none
            SnippetShowLinesValue.ONE, // one
            SnippetShowLinesValue.TWO, // two
            SnippetShowLinesValue.THREE // three
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSnippetShowLines = (ListPreference) findPreference(PreferenceKeys.SNIPPET_SHOW_LINES);
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        } else if (PreferenceKeys.SNIPPET_SHOW_LINES.equals(key)) {
            final int prefsSnippetShowLines = SNIPPET_SHOW_LINES_VALUES[mSnippetShowLines
                    .findIndexOfValue((String) newValue)];
            mMailPrefs.setSnippetShowLines(prefsSnippetShowLines);
    ...
    private void clearDisplayImages() {
        ...
        /* UNISOC: Modify for bug 1139107 {@ */
        fragment.showAllowingStateLoss(getActivity().getFragmentManager(),
    ...
    public void onResume() {
        ...
        final int snippetShowLinesIndex = prefValueToWidgetIndex(SNIPPET_SHOW_LINES_VALUES,
                mMailPrefs.getSnippetShowLines(), SnippetShowLinesValue.DEFAULT);
        mSnippetShowLines.setValueIndex(snippetShowLinesIndex);
        ...
        listenForPreferenceChange(
                ...
                PreferenceKeys.SNIPPET_SHOW_LINES
        );
    }
