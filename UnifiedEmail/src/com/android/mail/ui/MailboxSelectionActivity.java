...
public class MailboxSelectionActivity extends AppCompatActivity implements OnClickListener,
    ...
    /* SPRD: Modify for bug528866 {@ */
    private static final String IS_WAIT_VIEW_SHOW_KEY = "isWaitViewShow";
    private boolean mIsWaitViewShow = false;
    /* @} */
    ...
    protected void onSaveInstanceState(Bundle icicle) {
        ...
        /* SPRD: Modify for bug528866 {@ */
        if (mWait != null) {
            mIsWaitViewShow = mWait.getVisibility() == View.VISIBLE;
            icicle.putBoolean(IS_WAIT_VIEW_SHOW_KEY, mIsWaitViewShow);
            if (mIsWaitViewShow) {
    ...
    private void restoreState(Bundle icicle) {
        ...
        /* SPRD: Modify for bug528866 {@ */
        if (icicle.containsKey(IS_WAIT_VIEW_SHOW_KEY)) {
            mIsWaitViewShow = icicle.getBoolean(IS_WAIT_VIEW_SHOW_KEY);
        }
        /* @} */
    }
    ...
    private void selectAccount(Account account) {
        /* SPRD modify for bug713771 {@ */
        LogUtils.i(LOG_TAG, "MailboxSeletionActivity selectAccount  mAccountSelected:"
                + mAccountSelected);
        if (mAccountSelected) {
            return;
        }
