...
public abstract class FolderSelectionDialog extends DialogFragment implements OnClickListener {
    ...
    protected boolean mDialogShown; //UNISOC: Modify for bug 1163160
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        /* SPRD: Modify for bug508708 {@ */
        if(args.getParcelableArray(ARG_TARGET_TAG) instanceof Conversation[]){
    ...
    protected ConversationUpdater getConversationUpdater() {
        ...
        if (!isResumed()) {
            ...
            Log.e(LOG_TAG,"Tried to update conversations while fragment is not running");
            return null;
        }
