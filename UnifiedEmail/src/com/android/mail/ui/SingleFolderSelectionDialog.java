        ...
        getLoaderManager().initLoader(FOLDER_LOADER_ID, args,
                new LoaderManager.LoaderCallbacks<Cursor>() {
                    ...
                    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
                        ...
                        if (dialog == null || mDialogShown) { //UNISOC: Modify for bug 1163160
                        ...
                        /* UNISOC: Modify for bug 1179212 @{ */
                        Cursor cursor = AddableFolderSelectorAdapter.filterFolders(data);
                        UserFolderHierarchicalFolderSelectorAdapter hierarchicalAdapter =
                                new UserFolderHierarchicalFolderSelectorAdapter(context,
                                    cursor, R.layout.single_folders_view, mCurrentFolder);
                        /* @} */
                        ...
                        setDialogShown(true); //UNISOC: Modify for bug 1163160
                        cursor.close();// UNISOC: Modify for bug 1179212
                    }
