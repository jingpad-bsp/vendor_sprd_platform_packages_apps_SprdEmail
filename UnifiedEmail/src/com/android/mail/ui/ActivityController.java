...
import com.android.mail.ui.GoToTopAction.GoToTopListener;
...
public interface ActivityController extends LayoutListener,
        ...
        RecentFolderController, FragmentLauncher, KeyboardNavigationController, GoToTopListener {
    ...
    /**
     * Begin a search with the given query string and searchApproach.
     */
    void executeSearch(String query, int searchApproach);
    /* @} */
    ...
    /* SPRD:bug475886 add local search function @{ */
    /**
     * Search Email in databases with certain approach
     */
    void executeLocalSearch(String query, int searchApproach);
    ...
    boolean isExpansiveLayout();
    /* @} */

    /* SPRD: Modify for bug711539 @{ */
    void dismissTopButton();
    /* @} */

    /* SPRD modify for bug738293 {@ */
    boolean showActionModeMenu();
    /* @} */
}
