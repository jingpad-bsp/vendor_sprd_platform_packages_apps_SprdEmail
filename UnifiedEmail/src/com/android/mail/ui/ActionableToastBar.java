...
public class ActionableToastBar extends FrameLayout {
    ...
    public void show(final ActionClickedListener listener, final CharSequence descriptionText,
        ...
        /* SPRD:ADD for bug 495460 reset action view enable is true. @{*/
        if (mSingleLineActionView != null) {
            mSingleLineActionView.setEnabled(true);
            if (mMultiLineActionView != null) {
                mMultiLineActionView.setEnabled(true);
            }
        }
        /* }@*/
        ...
        setActionClickListener(new OnClickListener() {
            ...
            public void onClick(View widget) {
                ...
                /* SPRD:ADD for bug 495460 check widget enabled status and set disabled. @{*/
                if (!widget.isEnabled()) {
                    return;
                }
