...
public class Attachment implements Parcelable {
    ...
    public Attachment(Context context, Part part, Uri emlFileUri, String messageId, String cid,
        ...
        try {
            ...
            /* UNISOC: Modify for bug1201770 @{ */
            try (final InputStream in = part.getBody().getInputStream();
    ...
    public boolean canSave() {
        return !isSavedToExternal();//UNISOC: Modify for bug 1178725
    }

    public boolean canShare() {
        /* SPRD modify for bug651415 {@ */
        return isPresentLocally() && contentUri != null
                && !contentUri.getAuthority().equals(AttachmentUtilities.EML_ATTACHMENT_PROVIDER);
        /* @} */
    }
    ...
    public boolean isSavedToExternal() {
        ...
        return state == AttachmentState.SAVED && fileIsExistInDownload(name);
        /* @} */
    }

    /* SPRD: Modify for bug496733 {@ */
    private boolean fileIsExistInDownload(String fileName) {
     ...
     *@{
     */
    public boolean isAttachmentTooLargeAndNotWifi(Context context) {
