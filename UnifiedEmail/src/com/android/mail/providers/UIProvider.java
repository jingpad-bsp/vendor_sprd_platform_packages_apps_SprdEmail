...
public class UIProvider {
     ...
     *@{
     */
    public static final boolean ENABLE_MAIL_PRIORITY_FEATURE = true;
    /*@}*/
    ...
    public static final Map<String, Class<?>> ACCOUNTS_COLUMNS_NO_CAPABILITIES =
            ...
            .put(AccountColumns.SettingsColumns.SNIPPET_SHOW_LINES, Integer.class)
            .build();
    ...
    public static final class AccountColumns implements BaseColumns {
        ...
        public static final class SettingsColumns {
            ...
            public static final String SNIPPET_SHOW_LINES = "snippet_show_lines";
        }
    }
    ...
    public static final class SearchQueryParameters {
        ...
        public static final String QUERY_APPROACH = "query_approach";  //SPRD:bug475886 add local search function
    ...
    public static final String[] FOLDERS_PROJECTION = {
        ...
        FolderColumns.LOCAL_SEARCH_URI
    };
    /* @} */
    ...
    public static final int FOLDER_LOCAL_SEARCH_URI_COLUMN = 24;  //SPRD:bug475886 add local search function
    ...
    public static final class FolderType {
        ...
        /** All VIP mail folder */
        public static final int VIP = 1 << 13;
    }
    ...
    public static final class FolderColumns implements BaseColumns {
         ...
         */
        public static final String PARENT_URI = "parentUri";  //SPRD:bug475886 add local search function

        /**
         * The URI for local search.
         */
        public static final String LOCAL_SEARCH_URI = "localSearchUri";
    ...
    public static final String[] CONVERSATION_PROJECTION = {
         ...
         *@{
         */
        ConversationColumns.MAIL_PRIORITY
        /*@}*/
    };

    public static final class ConversationSortOrder {

        public static final String SORT_ORDER_PARAMETER = "sort_order_parameter";

        public static final int ASCEDANCE_MASK = 0xFFFF0000;
        public static final int ORDER_METHOD_MASK = 0xFFFF;
        ...
        public static final int TIME_STAMP_DESC = TIME_STAMP * 2 + DESC;
        public static final int TIME_STAMP_ASC = TIME_STAMP * 2 + ASC;

        public static final int DISPLAY_NAME_DESC = DISPLAY_NAME * 2 + DESC;
        public static final int DISPLAY_NAME_ASC = DISPLAY_NAME * 2 + ASC;

        public static final int SUBJECT_DESC = SUBJECT * 2 + DESC;
        public static final int SUBJECT_ASC = SUBJECT * 2 + ASC;

        public static int getAsc(int sortOrder) {
            return sortOrder % 2;
        }

        public static int getOrderMethod(int sortOrder) {
            return sortOrder / 2;
        }
     ...
     *@{
     */
    public static final int CONVERSATION_MAIL_PRIORITY_COLUMN = 27;
    /*@}*/
     ...
     */
    /**
    * Refer to "X-Priorify" field of header, it has 5 level range from 1 to 5.
    * We use three of it: 1, 3, 5.
    */
    public static final class MailPriority {
        public static final int HIGH = 1;   // Highest
        public static final int NORMAL = 3; // Normal
        public static final int LOW = 5;    // Lowest
    }

    /**
    * Refer to "Importance" field of header.
    */
    public static final class MailImportance {
        public static final int LOW = 0;   // "low"
        public static final int NORMAL = 1; // "normal"
        public static final int HIGH = 2;    // "high"
    }
    /*@}*/
    ...
    public static final class ConversationCursorCommand {
        ...
        public static final String COMMAND_KEY_IS_VIP_MAILBOX = "isVipMailbox";
        public static final String COMMAND_KEY_FILTER_VIP_MSG = "filterVipMSG";
        /**
     ...
     *@{
     */
    public static final int MESSAGE_MAIL_PRIORITY_COLUMN = 38;
    /*@}*/
    ...
    public static final class MessageColumns {
         ...
         */
        /**
         * This int column contains the mail priority. Use MailPriority to
    ...
    public static final String ATTACHMENT_CONTACT_URI_PREFIX = "content://com.android.contacts/contacts/";
    /* @} */

    /* SPRD: Modify for bug627832 {@ */
    public static final String ATTACHMENT_CONTACT_SUFFIX = ".vcf";
    /* @} */
