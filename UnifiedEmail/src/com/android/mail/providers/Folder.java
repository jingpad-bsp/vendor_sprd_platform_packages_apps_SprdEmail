...
public class Folder implements Parcelable, Comparable<Folder> {
    ...
    /**
     * The content provider URI to return the list of search results in this folder.
     */
    public Uri localSearchUri;
    /* @} */
    ...
    public static final class Builder {
        ...
        public Folder build() {
            return new Folder(mId, mPersistentId, mUri, mName, mCapabilities,
                    ...
                    mLastMessageTimestamp, mUnreadSenders, mLocalSearchUri);
        }
        /* @} */
        ...
        /* SPRD:bug475886 add local search function @{ */
        public Builder setLocalSearchUri(final Uri localSearchUri) {
            mLocalSearchUri = localSearchUri;
            return this;
        }
        /* @} */
    }
    ...
    public Folder(int id, String persistentId, Uri uri, String name, int capabilities,
            ...
            final long lastMessageTimestamp, final String unreadSenders, Uri localSearchUri) {
        this.id = id;
        ...
        this.localSearchUri = localSearchUri;
    }
    ...
    public Folder(Cursor cursor) {
        ...
        final String localSearchUriString = cursor
                .getString(UIProvider.FOLDER_LOCAL_SEARCH_URI_COLUMN);
        localSearchUri = localSearchUriString == null ? Uri.EMPTY : Uri.parse(localSearchUriString);
    ...
    public Folder(Parcel in, ClassLoader loader) {
        ...
        parent = in.readParcelable(loader);
        localSearchUri = in.readParcelable(loader);  //SPRD:bug475886 add local search function
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(parent, 0);
        dest.writeParcelable(localSearchUri, 0);  //SPRD:bug475886 add local search function
    ...
    public static ObjectCursorLoader<Folder> forSearchResults(Account account, String query,
        ...
        return forSearchResults(account, query, SearchParams.SEARCH_BY_ALL, queryIdentifier,
                context);
    }

    /**
     * Construct a folder that queries for search results. Do not call on the UI thread.
     */
    public static ObjectCursorLoader<Folder> forSearchResults(Account account, String query,
            int queryApproach,
            String queryIdentifier, Context context) {

        if (account != null && account.searchUri != null) {
            ...
            searchBuilder.appendQueryParameter(UIProvider.SearchQueryParameters.QUERY_IDENTIFER,
                    queryIdentifier);
            searchBuilder.appendQueryParameter(UIProvider.SearchQueryParameters.QUERY_APPROACH,
                    Integer.toString(queryApproach));
            final Uri searchUri = searchBuilder.build();
            return new ObjectCursorLoader<Folder>(context, searchUri,
    ...
    /*SPRD: modify for bug630222 {@*/
    public boolean isUnread() {
        return isType(FolderType.UNREAD);
    }
    /* @}*/

    public boolean isVIP() {
        return isType(FolderType.VIP);
    }
    ...
    /* SPRD:bug475886 add local search function @{ */
    public Uri getLocalSearchUri(String query, int approach) {
        return localSearchUri
                .buildUpon()
                .appendQueryParameter(UIProvider.SearchQueryParameters.QUERY, query)
                .appendQueryParameter(UIProvider.SearchQueryParameters.QUERY_APPROACH,
                        Integer.toString(approach)).build();
    }
    /* @} */
}
