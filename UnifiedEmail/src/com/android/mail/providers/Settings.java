...
public class Settings implements Parcelable {
    ...
    public final int snippetShowLines;
    ...
    private Settings() {
        ...
        snippetShowLines = MailPrefs.SnippetShowLinesValue.DEFAULT;
    }
    ...
    public Settings(Parcel inParcel) {
        ...
        snippetShowLines = inParcel.readInt();
    }
    ...
    public Settings(Cursor cursor) {
        ...
        snippetShowLines = cursor.getInt(
                cursor.getColumnIndex(SettingsColumns.SNIPPET_SHOW_LINES));
    }
    ...
    private Settings(JSONObject json) {
        ...
        snippetShowLines = json.optInt(
                SettingsColumns.SNIPPET_SHOW_LINES, sDefault.snippetShowLines);
    ...
    public synchronized JSONObject toJSON() {
        ...
        try {
            ...
            json.put(SettingsColumns.SNIPPET_SHOW_LINES, snippetShowLines);
    ...
    public Map<String, Object> getValueMap(Map<String, Object> map) {
        ...
        map.put(SettingsColumns.SNIPPET_SHOW_LINES, snippetShowLines);
        return map;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(snippetShowLines);
    }
    ...
    public boolean equals(final Object aThat) {
        ...
        return (TextUtils.equals(signature, that.signature)
                ...
                && snippetShowLines == that.snippetShowLines;
    }
    ...
    public int hashCode() {
        if (mHashCode == 0) {
            mHashCode = super.hashCode()
                    ...
                    welcomeTourShownVersion, snippetShowLines);
        }
        return mHashCode;
    }
}
