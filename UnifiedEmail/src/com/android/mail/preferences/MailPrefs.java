...
public final class MailPrefs extends VersionedPrefs {
    ...
    public static final class PreferenceKeys {
        ...
        public static final String UNDO_MESSAGE_ID =
                "undo-message-id";
        /* @}*/

        public static final String SNIPPET_SHOW_LINES = "snippet-show-lines";
    ...
    public static final class SnippetShowLinesValue {
        public static final int NONE = 0; // "none"
        public static final int ONE = 1; // "one"
        public static final int TWO = 2; // "two"
        public static final int THREE = 3;// "three"
        public static final int DEFAULT = ONE;// "one"
    }
    ...
    public void setSnippetShowLines(final int lines) {
        getEditor().putInt(PreferenceKeys.SNIPPET_SHOW_LINES, lines).apply();
        notifyBackupPreferenceChanged();
    }

    public int getSnippetShowLines() {
        return getSharedPreferences()
                .getInt(PreferenceKeys.SNIPPET_SHOW_LINES, SnippetShowLinesValue.DEFAULT);
    }
    ...
    /*SPRD: modify for bug611469 {@*/
    public void setUndoMessage(Set<String> undoMessage) {
        getEditor().putStringSet(PreferenceKeys.UNDO_MESSAGE_ID, undoMessage).apply();
        notifyBackupPreferenceChanged();
    }

    public void clearUndoMessage() {
        getEditor().putStringSet(PreferenceKeys.UNDO_MESSAGE_ID, Collections.emptySet()).apply();
        notifyBackupPreferenceChanged();
    }

    public Set<String> getUndoMessage() {
        final SharedPreferences sharedPreferences = getSharedPreferences();
        final Set<String> defauleUndoMessage = Collections.emptySet();
        return sharedPreferences.getStringSet(PreferenceKeys.UNDO_MESSAGE_ID, defauleUndoMessage);
    }
    /* @}*/
}
