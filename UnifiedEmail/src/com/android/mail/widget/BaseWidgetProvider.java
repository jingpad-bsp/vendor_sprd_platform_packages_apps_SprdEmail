...
public abstract class BaseWidgetProvider extends AppWidgetProvider {
    ...
    protected int[] getCurrentWidgetIds(Context context) {
        ...
        /* SPRD: Modify for bug 573337 {@ */
        try {
            return appWidgetManager.getAppWidgetIds(mailComponent);
        } catch (RuntimeException e) {
            LogUtils.e("js", e, "Couldn't get app widget id");
            return new int[]{};
        }
        /* @} */
    }
    ...
    public static void updateWidget(Context context, int appWidgetId, Account account,
        ...
        updateWidgetIntent.setClassName(context.getPackageName(),
    ...
    public static void validateAllWidgets(Context context, String accountMimeType) {
        ...
        migrateAllWidgetsIntent.setClassName(context.getPackageName(),
                com.android.email.provider.WidgetProvider.class.getName());
    ...
    protected void updateWidgetInternal(Context context, int appWidgetId, Account account,
        ...
        if (!isAccountValid(context, account) || !isFolderValid(context, folderUri)) {
            ...
            /* SPRD modify for bug743159 {@ */
            configureIntent.addFlags(Intent.FLAG_ACTIVITY_EXCLUDE_FROM_RECENTS);
            /* @} */
            /* UNISOC: Modify for bug1018241 {@ */
            configureIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK
    ...
    protected void configureValidAccountWidget(Context context, RemoteViews remoteViews,
        ...
        WidgetService.configureValidAccountWidget(context, remoteViews, appWidgetId, account,
                ...
                WidgetService.class);
        /* UNISOC: Modify for bug1030375 {@ */
        WidgetService.saveWidgetInformation(context, appWidgetId, account, folderUri.toString());
        /* @} */
    }
