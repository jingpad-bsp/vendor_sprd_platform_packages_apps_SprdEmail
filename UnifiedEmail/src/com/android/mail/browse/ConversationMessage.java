...
public final class ConversationMessage extends Message {
    ...
    public Folder getFolder() {
        final FolderController folderController = mController != null
                ? mController.getFolderController() : null;
        Folder folder = null;
    ...
    public void star(boolean newStarred) {
        ...
        if (listController != null) {
            ...
            final FolderController folderController = mController.getFolderController();
            if (!newStarred && folderController != null) {
                Folder folder = folderController.getFolder();
                if (folder != null && folder.isType(FolderType.STARRED)) {
                    listController.onConversationSelected(null, true);
                }
            }
            /* @} */
        }
