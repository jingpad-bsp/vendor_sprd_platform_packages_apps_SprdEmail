...
public class EmlMessageLoader extends MailAsyncTaskLoader<ConversationMessage> {
    ...
    public ConversationMessage loadInBackground() {
        ...
        try {
            ...
            stream = new BufferedInputStream(resolver.openInputStream(mEmlFileUri));
            /* @} */
        ...
        /*SPRD modify for bug619950 {@ */
            ...
            LogUtils.e(LOG_TAG, e, "SecurityException when file not exist: %s", mEmlFileUri);
            return null;
        /* @} */
        }
        ...
        try {
            ...
            LogUtils.e(LOG_TAG, e, "Unexpected end of eml file");
            return null;
        } catch (IOException e) {
