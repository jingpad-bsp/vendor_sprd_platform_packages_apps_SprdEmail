...
public class ConversationViewHeader extends LinearLayout implements OnClickListener,
    ...
    public void onClick(View v) {
        ...
        if (mConversation != null && id == R.id.conversation_header_star) {
            ...
            if (mCallbacks != null) {
                mCallbacks.onConversationViewHeaderStarredChange(mConversation.starred);//UNISOC: Modify for bug 504210,1228229
    ...
    public boolean onLongClick(View v) {
        ...
        /* SPRD: Modify for bug652460, origin bug496341 {@ */
        if (mCallbacks != null) {
            Activity activity = mCallbacks.getActivity();
            if (activity != null) {
                frag.show(activity.getFragmentManager(), CopySubjectDialog.TAG);
            }
        }
        /* @} */
        return true;
    ...
    public static class CopySubjectDialog extends DialogFragment
        ...
        public void onClick(DialogInterface dialog, int which) {
            /* SPRD: Modify for bug652460 {@ */
            if (which == DialogInterface.BUTTON_POSITIVE) {
                Activity activity = getActivity();
                if (activity != null) {
                    final ClipboardManager clipboard = (ClipboardManager) activity
