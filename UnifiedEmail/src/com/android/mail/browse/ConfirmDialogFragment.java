...
public class ConfirmDialogFragment extends DialogFragment {
    ...
    private final AlertDialog.OnClickListener POSITIVE_ACTION = new AlertDialog.OnClickListener() {
        ...
        public void onClick(DialogInterface arg0, int arg1) {
            ...
            // development.
            /* SPRD modify for bug642441{@ */
            ControllableActivity activity = (ControllableActivity) getActivity();
            ConversationUpdater conversationUpdater = activity == null ? null : activity
                    .getConversationUpdater();
            final AlertDialog.OnClickListener listener = conversationUpdater == null ? null
                    : conversationUpdater.getListener();
            /* @} */
            if (listener != null) {
