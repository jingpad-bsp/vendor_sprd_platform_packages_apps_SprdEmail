...
public abstract class FragmentStatePagerAdapter2 extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (mEnableSavedStates && mSavedState.size() > position) {
            ...
            /* UNISOC: Modify for bug1208650 {@ */
            if (fss != null && fragment != null) {
        ...
        if (fragment == null) {
            LogUtils.w("FragmentStatePagerAdapter", "fragment if null !");
        } else {
    ...
    public Parcelable saveState() {
        ...
        for (int i=0; i<mFragments.size(); i++) {
            ...
            String key = "f" + pos;
            /* UNISOC: Modify for bug1217834 @{ */
            try {
                mFragmentManager.putFragment(state, key, f);
            } catch (RuntimeException e) {
                LogUtils.d(TAG, "Transaction Too Large!" + e);
            }
            /* @} */
        }
        return state;
