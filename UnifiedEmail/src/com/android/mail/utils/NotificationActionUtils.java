...
public class NotificationActionUtils {
    ...
    /* UNISOC: Modify for bug1122279 {@ */
    private static String UNDO_NOTIFICATION_ID = "UNDO_NOTIFICATION";
    private static String UNDO_NOTIFICATION_NAME = "Undo email";
    /* @}*/
    ...
    public static Notification createUndoNotification(final Context context,
        ...
        /* UNISOC: Modify for bug1122279 {@ */
        NotificationChannel undoChannel = new NotificationChannel(UNDO_NOTIFICATION_ID,
                UNDO_NOTIFICATION_NAME,
                NotificationManager.IMPORTANCE_DEFAULT);
        context.getSystemService(NotificationManager.class).createNotificationChannel(undoChannel);
        builder.setChannelId(UNDO_NOTIFICATION_ID);
        /* @}*/
    ...
    public static void registerUndoNotificationObserver(final DataSetObserver observer) {
        /* SPRD: Modify for bug 752312 @{ */
        try {
            sUndoNotifications.getDataSetObservable()
    ...
    public static void unregisterUndoNotificationObserver(final DataSetObserver observer) {
        /* SPRD: Modify for bug 752312 @{ */
        try {
            sUndoNotifications.getDataSetObservable().unregisterObserver(
                    observer);
        } catch (IllegalStateException e) {
            e.printStackTrace();
        }
    ...
    private static void putNotificationActionExtra(final Intent intent,
        ...
        out.recycle(); //UNISOC: Modify for bug 1179214
    }
}
