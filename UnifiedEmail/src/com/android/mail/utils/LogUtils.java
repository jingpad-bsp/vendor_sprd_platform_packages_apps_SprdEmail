...
public class LogUtils {
    ...
    public static final String LOCAL_SEARCH_TAG = "LOCAL_SEARCH";  //SPRD:bug475886 add local search function
    ...
    public static boolean isLoggable(String tag, int level) {
        ...
        return true;//Log.isLoggable(tag, level) || Log.isLoggable(TAG, level);
    }
