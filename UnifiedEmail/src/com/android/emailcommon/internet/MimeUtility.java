...
public class MimeUtility {
    ...
    public static String decode(String s) {
        ...
        return DecoderUtil.decodeEncodedWords(s, DecodeMonitor.STRICT); // UNISOC: Modify for bug 1206799
    }
                ...
                if (mimeType != null && MimeUtility.mimeTypeMatches(mimeType, "text/*")) {
                    ...
                    try (ByteArrayOutputStream out = new ByteArrayOutputStream();
                        ...
                        if (charset != null) {
                             ...
                             */
                            charset = CharsetUtil.lookup(charset).name(); // UNISOC: Modify for bug 1206799
                        }
                        /*
                         * No encoding, so use us-ascii, which is the standard.
                         */
                        if (charset == null) {
                            /* SPRD Modify for bug499545 */
                            charset = "UTF-8";
                            /* @} */
                        }
                        /*
    ...
    public static void collectParts(Part part, ArrayList<Part> viewables,
        ...
        /* SPRD Modify bug497841 qq mail not show cvs/vcard att */
        ...
        boolean inline = (TextUtils.isEmpty(contentTypeName) && TextUtils.isEmpty(dispositionType))
        ...
        } else if (inline && !mimeType.equals("text/calendar")
