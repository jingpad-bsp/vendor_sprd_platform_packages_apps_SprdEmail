...
public class MimeBodyPart extends BodyPart {
    ...
    public void setBody(Body body) throws MessagingException {
        ...
        if (body instanceof com.android.emailcommon.mail.Multipart) {
            ...
            String contentType = String.format("%s;%n charset=utf-8", getMimeType());  //UNISOC: Modify for bug1232943
            String name = MimeUtility.getHeaderParameter(getContentType(), "name");
            if (name != null) {
                contentType += String.format(";%n name=\"%s\"", name);  //UNISOC: Modify for bug1232943
            }
