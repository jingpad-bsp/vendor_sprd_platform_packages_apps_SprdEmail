...
public class CharsetMatch implements Comparable<CharsetMatch> {
     ...
     *            source of the data is an input stream, or -1 for unlimited
     *            length.
     * @return a String created from the converted input data.
     *
     * @stable ICU 3.4
    ...
    public String getString(int maxLength) throws java.io.IOException {
        ...
        if (fInputStream != null) {
             ...
             * cannot be used to open a charset (e.g. IBM424_rtl). The ending
             * '_rtl' or 'ltr' should be stripped off before creating the
             * string.
             */
            int startSuffix = name.indexOf("_rtl") < 0 ? name.indexOf("_ltr")
                    : name.indexOf("_rtl");
            if (startSuffix > 0) {
    ...
    /* UNISOC: Modify for bug1208637 {@ */
    public boolean equals(Object o) {
        boolean isEqual = false;
        if (o == null || !(o instanceof CharsetMatch)) {
            return false;
        }
        if (((CharsetMatch) o).fConfidence == this.fConfidence) {
            isEqual = true;
        }
        return isEqual;
    }
     ...
     * @return a negative integer, zero, or a positive integer as the confidence
