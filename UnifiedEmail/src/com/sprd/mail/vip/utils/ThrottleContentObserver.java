...
/**
 * SPRD: This class aim to ignore some notification when database changed frequently.
...
public class ThrottleContentObserver extends ContentObserver {
    ...
    public ThrottleContentObserver(Handler handler, Context context, Runnable runnable, String name) {
        super(handler);
