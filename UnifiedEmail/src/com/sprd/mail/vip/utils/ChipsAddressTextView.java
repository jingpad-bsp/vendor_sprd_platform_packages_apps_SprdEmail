...
public class ChipsAddressTextView extends RecipientEditTextView {
    ...
    /**
     * SPRD: An {@link InputFilter} that implements special address cleanup rules.
    ...
    private static class ForwardValidator implements Validator {
        ...
        public CharSequence fixText(CharSequence invalidText) {
            //SPRD: use the mValidator fixText to fix the text, such as append the domain
    ...
    /**
     * SPRD: Clear recipientsView's popup view.
     * @param newConfig
     */
    @Override
