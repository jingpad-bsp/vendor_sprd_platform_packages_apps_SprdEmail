...
import com.sprd.mail.vip.utils.ChipsAddressTextView;
...
public class VipAddressTextView extends ChipsAddressTextView {
    ...
    private Address[] getAddresses(TextView view) {
        /** SPRD: check the address is valid or not, and alter user. @{ */
    ...
    public boolean onEditorAction(TextView view, int action, KeyEvent keyEvent) {
        ...
        /// SPRD: We should do default action when popupshowing, cause "add pop up item to textview"
