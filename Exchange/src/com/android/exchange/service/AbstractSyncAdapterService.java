...
public abstract class AbstractSyncAdapterService extends Service {
    ...
    /* UNISOC: Modify for bug1194340 @{ */
    private static int NOTIFICATION_ID = 0;
    private static String NOTIFICATION_CHANNEL = "AUTH_ERROR_NOTIFICATION_CHANNEL";
    /* @} */
    ...
    protected void showAuthNotification(long accountId, String accountName) {
        ...
        builder.setContentTitle(this.getString(R.string.auth_error_notification_title))
                ...
                .setAutoCancel(true);
        nm.notify("AuthError", NOTIFICATION_ID, builder.build());
        /* @} */
    }
