...
public class EmailSyncAdapterService extends AbstractSyncAdapterService {
    ...
    public void onCreate() {
        ...
        super.onCreate();
        startForegroundService(new Intent(this, EmailSyncAdapterService.class));
        final NotificationManager nmchannel = EmailSyncAdapterService.this.getSystemService(NotificationManager.class);
        final NotificationChannel channel = new NotificationChannel(Eas.NOTIFICATION_CHANNEL,
                EmailSyncAdapterService.this.getString(R.string.exchange_eas_name),
