...
import com.android.exchange.eas.EasOutOfOfficeSetting;
...
public class EasService extends Service {
    ...
    private final IEmailService.Stub mBinder = new IEmailService.Stub() {
       ...
       /* SPRD: bug523600 add OOF function {@ */
        ...
        public OofParams syncOof(long accountId, OofParams oofParams, boolean isGet) {
            return EasOutOfOfficeSetting.doSyncOof(EasService.this, accountId, oofParams, isGet);
        }

        @Override
        public void stopOof(long accountId) {
            EasOutOfOfficeSetting.doStopOof(accountId);
        }
        /* @} */
    };
    ...
    public void onCreate() {
        ...
        /* SPRD: Modify for bug697209, 709490 @{ */
        startForegroundService(new Intent(this, EasService.class));
        final NotificationManager nmchannel = EasService.this.getSystemService(NotificationManager.class);
        final NotificationChannel channel = new NotificationChannel(Eas.NOTIFICATION_CHANNEL,
                EasService.this.getString(R.string.exchange_eas_name),
                NotificationManager.IMPORTANCE_LOW);
        channel.setShowBadge(false); //UNISOC: Modify for bug 1147924
        nmchannel.createNotificationChannel(channel);
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this);
        builder.setContentTitle(this.getString(R.string.exchange_eas_name)); //UNISOC: Modify for bug 1166156
        builder.setChannelId(Eas.NOTIFICATION_CHANNEL);
        builder.setSmallIcon(R.drawable.ex_notification_icon); //UNISOC: Modify for bug 1157277
        startForeground(Eas.NOTIFICATION_ID, builder.build());
        /* @} */
    ...
    public int onStartCommand(final Intent intent, final int flags, final int startId) {
        if (intent != null &&
            ...
            if (intent.getBooleanExtra(ServiceProxy.EXTRA_FORCE_SHUTDOWN, false)) {
                ...
                LogUtils.i(TAG, "Forced shutdown, killing process");
                System.exit(-1);
            } else if (intent.getBooleanExtra(EXTRA_START_PING, false)) {
                LogUtils.i(TAG, "Restarting ping");
