...
public class EasSearch extends EasOperation {
    ...
    private static final String SIMPLE_FORMAT = "yyyy-MM-dd'T'HH:mm:ss.S'Z'";//UNISOC: Modify for bug1234482
    ...
    public SimpleDateFormat formatDate() {
        ...
        final SimpleDateFormat sdf = new SimpleDateFormat(SIMPLE_FORMAT, Locale.US);
    ...
    protected HttpEntity getRequestEntity() throws IOException {
        ...
        try {
            ...
            if (mSearchParams.mStartDate != null) {
                ...
                s.data(Tags.SEARCH_VALUE, formatDate().format(mSearchParams.mStartDate));//UNISOC: Modify for bug1234482
                s.end(); // SEARCH_GREATER_THAN
            }
            if (mSearchParams.mEndDate != null) {
                s.start(Tags.SEARCH_LESS_THAN);
                s.tag(Tags.EMAIL_DATE_RECEIVED);
                s.data(Tags.SEARCH_VALUE, formatDate().format(mSearchParams.mEndDate));//UNISOC: Modify for bug1234482
