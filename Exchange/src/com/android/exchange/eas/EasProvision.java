...
public class EasProvision extends EasOperation {
    ...
    public final boolean provision() {
        ...
        /* UNISOC: Modify for bug1232943 @{ */
        if (Double.compare(version, Eas.SUPPORTED_PROTOCOL_EX2007_SP1_DOUBLE) == 0
                || Double.compare(version, Eas.SUPPORTED_PROTOCOL_EX2010_DOUBLE) == 0) {
        /* @} */
